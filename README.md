...
This package is particularly useful if your team or company is building your product using microservices architecture, using C# language.
...
If you are interested in an installable service that can provide similar functionality please see [this page](https://github.com/seek-oss/seek.automation.phantom).
...
Then, everything is the same as normal pact testing process, except, you do the verifications multiple times by using the
...
If you receive "Access Denied", please check the account that you are using to run your project.
